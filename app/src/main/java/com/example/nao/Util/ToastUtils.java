...
/**
 * Created by 爱冒险的小鸡仔 on 2018/4/20.
 */
...
public class ToastUtils {
    ...
    public static void makeShortText(String msg, Context context){
        ...
        if (shortToast == null){
            shortToast = Toast.makeText(context, msg, Toast.LENGTH_LONG);
        }else {
    ...
    public static void showLong(Context context, String msg){ makeLongText(msg, context);}

    public static void showLong(Context context, int id){
        makeLongText(context.getResources().getString(id), context);
    }

    public static void showShort(Context context,String msg){makeShortText(msg, context);}
